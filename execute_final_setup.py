...
# This will trigger the conftest.py setup when imported
sys.path.insert(0, r'D:\calculator\calculator')

# Create the test directory structure directly
test_dir = r'D:\calculator\calculator\tests'
...
test_file = os.path.join(test_dir, 'test_calculator.py')
test_content = '''"""
...
abs_tests_dir = os.path.abspath(test_dir)
...
print(f"Directory exists: {os.path.isdir(test_dir)}")
print(f"Directory is readable: {os.access(test_dir, os.R_OK)}")
print(f"Directory is writable: {os.access(test_dir, os.W_OK)}")
