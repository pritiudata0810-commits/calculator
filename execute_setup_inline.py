#!/usr/bin/env python3
"""Inline setup script to create test directory structure."""
import os
import sys
...
try:
    ...
    # Create test_calculator.py with full content
...
'''
    ...
    # Verification
    print("\n--- Verification ---")
    print(f"Tests directory exists: {os.path.isdir(tests_dir)}")
    print(f"__init__.py exists: {os.path.isfile(init_file)}")
    print(f"test_calculator.py exists: {os.path.isfile(test_file)}")
