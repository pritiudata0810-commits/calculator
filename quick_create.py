...
open(r'D:\calculator\calculator\tests\__init__.py', 'w').close()
test_code='''"""
...
'''
open(r'D:\calculator\calculator\tests\test_calculator.py', 'w').write(test_code)
print("✓ Created tests directory and files")
