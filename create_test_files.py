...
with open(r'tests\__init__.py', 'w') as f:
    pass
print('✓ Created tests/__init__.py')

# 3. Create test_calculator.py with the exact content
test_content = '''"""
...
with open(r'tests\test_calculator.py', 'w') as f:
    f.write(test_content)
print('✓ Created tests/test_calculator.py')

# 4. Verify files exist and get their sizes
print('\n--- VERIFICATION ---')
import os

tests_dir = r'tests'
files_to_check = ['__init__.py', 'test_calculator.py']
...
# 5. Display summary
print('\n--- SUMMARY ---')
print(f'Directory: tests')
print(f'Files created:')
print(f'  • tests/__init__.py (empty file)')
print(f'  • tests/test_calculator.py (1 test class, 10 test methods)')
