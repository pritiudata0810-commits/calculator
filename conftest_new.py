"""Enhanced conftest.py that ensures test structure exists before running tests."""
import os
import sys
...
def pytest_configure(config):
    ...
    This creates the test directory structure if it doesn't exist.
    """
    # Get the directory containing this conftest.py
    conftest_dir = os.path.dirname(os.path.abspath(__file__))
    
    # Create the tests directory relative to the calculator directory
    tests_dir = os.path.join(conftest_dir, 'tests')
